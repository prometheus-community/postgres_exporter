// This file contains metric maps which are shipped out of the box with the exporter, and functions to make
// value-based copies of them to be loaded into exporter instances.
