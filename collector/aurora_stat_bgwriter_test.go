...
func TestAuroraStatBgwriterCollector(t *testing.T) {
	...
	mock.ExpectQuery(sanitizeQuery(auroraStatBgwriterQuery)).
		WillReturnRows(sqlmock.NewRows([]string{"orcache_blks_written", "orcache_blk_write_time"}).
			AddRow(246522, 339276.404))
	...
	convey.Convey("Two counters emitted", t, func() {
