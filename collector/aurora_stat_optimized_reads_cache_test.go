...
func TestAuroraStatOptimizedReadsCacheCollector(t *testing.T) {
	...
	mock.ExpectQuery(sanitizeQuery(auroraStatOptimizedReadsCacheQuery)).
		WillReturnRows(sqlmock.NewRows([]string{"total_size", "used_size"}).AddRow(1131705600000, 1046771367936))
	...
	convey.Convey("Two metrics emitted", t, func() {
