...
// StaticConnector implements the database/sql/driver.Connector interface, so it can be used with sql.OpenDB.
var _ driver.Connector = (*StaticConnector)(nil)

// StaticConnector is a Connector for a fixed DSN, e.g. userpass auth. It connects the
